...
// HISPCP/LOSPCP prescale register settings, normally it will be set to default values
   SysCtrlRegs.HISPCP.all = 4;          // HSPCLK = SYSCLKOUT / 10 = 30 MHz for ADC clk
   SysCtrlRegs.LOSPCP.bit.LSPCLK = 1;   // LSPCLK = SYSCLKOUT / 2 = 150 MHz

// XCLKOUT to SYSCLKOUT ratio.
   XintfRegs.XINTCNF2.bit.XTIMCLK = 1;
   XintfRegs.XINTCNF2.bit.CLKMODE = 1;
   XintfRegs.XINTCNF2.bit.BY4CLKMODE = 1; // XCLKOUT = 1/8 SYSCLKOUT
