...
// Checkin $Date: February 1, 2008   10:00:09 $
//###########################################################################
//
// FILE:    DSP2834x_SWPrioritizedDefaultIsr.c
//
// TITLE:   DSP2834x Device Default Software Prioritized Interrupt Service Routines.
//
//###########################################################################
//
...
#include "DSP2834x_SWPrioritizedIsrLevels.h"
...
#if (G53PL != 0)
interrupt void EQEP3_INT_ISR(void)     // eQEP3 Interrupt
{
	// Set interrupt priority:
	volatile Uint16 TempPIEIER = PieCtrlRegs.PIEIER5.all;
	IER |= M_INT5;
