...
#define	INT2PL      2        // Group2 Interrupts (PIEIER2) - EPWM1_TZINT
#define	INT3PL      3        // Group3 Interrupts (PIEIER3) - EPWM1_INT
...
#define	INT8PL      0        // Group8 Interrupts (PIEIER8)
#define	INT9PL      5        // Group9 Interrupts (PIEIER9) - SCIRXINTA, SCITXINTB
#define	INT10PL     0        // Group10 Interrupts (PIEIER10)
#define	INT11PL     4        // Group11 Interrupts (PIEIER11) - EPWM9_INT
#define	INT12PL     0        // Group12 Interrupts (PIEIER12)
#define	INT13PL     0        // XINT13
#define	INT14PL     0        // INT14 (TINT2)
#define	INT15PL     0        // DATALOG
#define	INT16PL     1        // RTOSINT
...
// 8  = lowest priority
//
#define	G11PL       1        // reserved
#define	G12PL       2        // reserved
#define	G13PL       3        // reserved
#define	G14PL       0        // XINT1       (External)
#define	G15PL       0        // XINT2       (External)
#define	G16PL       6        // reserved
...
#define	G27PL       0        // EPWM7_TZINT (ePWM7 Trip)
#define	G28PL       0        // EPWM8_TZINT (ePWM8 Trip)
...
#define	G37PL       0        // EPWM7_INT   (ePWM7 Int)
#define	G38PL       0        // EPWM8_INT   (ePWM8 Int)
...
#define	G47PL       7        // reserved
#define	G48PL       8        // reserved

#define	G51PL       0        // EQEP1_INT   (eQEP1 Int)
#define	G52PL       0        // EQEP2_INT   (eQEP2 Int)
#define	G53PL       0        // EQEP3_INT   (eQEP3 Int)
#define	G54PL       4        // reserved
#define	G55PL       5        // reserved
#define	G56PL       6        // reserved
#define	G57PL       7        // reserved
#define	G58PL       8        // reserved
...
#define	G67PL       0        // SPIRXINTD   (SPI-D)
#define	G68PL       0        // SPITXINTD   (SPI-D)
...
#define	G77PL       7        // reserved
#define	G78PL       8        // reserved

#define	G81PL       0        // I2CINT1A    (I2C-A)
#define	G82PL       0        // I2CINT2A    (I2C-A)
#define	G83PL       3        // reserved
#define	G84PL       4        // reserved
#define	G85PL       0        // SCIRXINTC   (SCI-C)
#define	G86PL       0        // SCITXINTC   (SCI-C)
#define	G87PL       7        // reserved
#define	G88PL       8        // reserved

#define	G91PL       1        // SCIRXINTA   (SCI-A)
#define	G92PL       2        // SCITXINTA   (SCI-A)
...
#define	G101PL      0        // EPWM9_TZINT (ePWM9 Trip)
#define	G102PL      2        // reserved
#define	G103PL      3        // reserved
#define	G104PL      4        // reserved
#define	G105PL      5        // reserved
#define	G106PL      6        // reserved
#define	G107PL      7        // reserved
#define	G108PL      8        // reserved

#define	G111PL      1        // EPWM9_INT   (ePWM9 Int)
#define	G112PL      2        // reserved
#define	G113PL      3        // reserved
#define	G114PL      4        // reserved
#define	G115PL      5        // reserved
#define	G116PL      6        // reserved
#define	G117PL      7        // reserved
#define	G118PL      8        // reserved
...
#define	G126PL      6        // reserved
#define	G127PL      7        // LVF         (FPA32)
#define	G128PL      8        // LUF         (FPA32)
